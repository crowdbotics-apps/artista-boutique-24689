"""artista_boutique_24689 URL Configuration
...
admin.site.site_header = "Artista Boutique"
admin.site.site_title = "Artista Boutique Admin Portal"
admin.site.index_title = "Artista Boutique Admin"

# swagger
api_info = openapi.Info(
    title="Artista Boutique API",
    default_version="v1",
    description="API documentation for Artista Boutique App",
)
